...
exports.sourceNodes = async (
  ...
  const promisesContentTypes = contentTypes.map(contentType =>
    fetchData({
      apiURL,
      contentType,
      jwtToken,
  ...
  const promisesSingleTypes = singleTypes.map(singleType =>
    fetchData({
      apiURL,
      singleType,
      jwtToken,
  ...
  // Create/update contentType nodes
